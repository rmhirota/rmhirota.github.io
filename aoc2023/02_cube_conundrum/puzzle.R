...
# here; would you like to play a game^[No, the Elf's name is not 'WOPR'.
# It's Joshua.] in the meantime?
#
...
aor::day_continue("2023-12-02", "aoc2023/02_cube_conundrum/puzzle.R")
